...
- Cache-busting: both CSS/JS links use `?v=20260204c`; bump that token whenever you update `ccc.css` or `ccc.js` so browsers pick up the latest build. GitHub Pages updates a few minutes after each push to `main`.
