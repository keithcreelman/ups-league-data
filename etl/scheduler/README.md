...
- `com.keith.mfl.rostersweekly.inseason.daily.plist`: daily at 12:20 AM local time
...
cp "/Users/keithcreelman/Documents/New project/etl/scheduler/com.keith.mfl.rostersweekly.inseason.daily.plist" \
   "$HOME/Library/LaunchAgents/"
...
launchctl bootstrap gui/$(id -u) "$HOME/Library/LaunchAgents/com.keith.mfl.rostersweekly.inseason.daily.plist"
```
...
launchctl print gui/$(id -u)/com.keith.mfl.rostersweekly.inseason.daily
```
